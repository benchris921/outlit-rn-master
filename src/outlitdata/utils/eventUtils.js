...
/**
 * Cancels out all types that are not provided in the given map;
 *
 * @param {Object} types the types map
 * @return {Object} the modified types map
 */
function cancelOtherTypes(types) {
  const newTypes = {};
  if (Object.prototype.toString.call(types) === '[object Object]') {
    Object.keys(VALID_META_STRUCTURE.types).forEach((type) => {
      if (types[type] === undefined) {
        ...
        // just copy the already present value
